...
namespace exqudens::log::util {
    ...
    std::vector<std::string> FormatterUtils::splitFormat(const std::string& format, const std::set<std::string>& targets, char escape) {
        try {
    ...
    std::string FormatterUtils::toStringTimestamp(const std::chrono::system_clock::time_point& value, const std::string& format, unsigned short seconds, const std::map<unsigned short, long long>& secondsDeviderMap, size_t size, bool reverse) {
        try {
    ...
    std::string FormatterUtils::toStringLevel(unsigned short value, bool name, const std::map<unsigned short, std::string>& levelNameMap, size_t size, bool reverse) {
        try {
            std::string result = {};
    ...
    std::string FormatterUtils::toStringThread(const std::thread::id& value, size_t size, bool reverse) {
        try {
            std::string result = {};
    ...
    std::string FormatterUtils::toStringLogger(const std::string& value, size_t size, bool reverse) {
        try {
    ...
    std::string FormatterUtils::toStringFunction(const std::string& value, size_t size, bool reverse) {
        try {
            std::string result = value;
            result = toStringSizeReverse(result, size, reverse);
            return result;
    ...
    std::string FormatterUtils::toStringFile(const std::string& value, const std::string& base, bool name, size_t size, bool reverse) {
        try {
            std::string result = {};
    ...
    std::string FormatterUtils::toStringLine(size_t value, size_t size, bool reverse) {
        try {
    ...
    std::string FormatterUtils::toStringMessage(const std::string& value, size_t size, bool reverse) {
        try {
            std::string result = value;
            result = toStringSizeReverse(result, size, reverse);
            return result;
    ...
    std::string FormatterUtils::toStringSizeReverse(const std::string& value, size_t size, bool reverse) {
        try {
            std::string result = value;
