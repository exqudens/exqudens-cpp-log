...
class LogIntegrationTests: public testing::Test {
    ...
    protected:
        ...
        inline static const char* LOGGER_ID = "LogIntegrationTests";
...
TEST_F(LogIntegrationTests, test_1) {
    try {
        ...
        std::filesystem::path testOutputDir(TestUtils::getTestOutputDir(testGroup, testCase).value());
        ...
        std::string loggingConfig = exqudens::Log::configure(loggingFile, loggingFileSize, loggerIdSet);
